Public Interface IUniverse
    ...
    Function CreateStar(starName As String, starType As String) As IStarVicinity
    Function CreatePlanet(planetName As String, planetType As String) As IPlanetVicinity
