...
Public Class UniverseData
    ...
    Property Actors As New BucketData(Of ActorData) Implements IUniverseData.Actors
    Property Locations As New BucketData(Of LocationData) Implements IUniverseData.Locations
