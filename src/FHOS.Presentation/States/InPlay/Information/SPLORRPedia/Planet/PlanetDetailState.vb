...
Friend Class PlanetDetailState
    ...
    Public Overrides Sub HandleCommand(cmd As String)
        Select Case cmd
            Case Command.B
                Context.Model.Ephemerals.SelectedPlanet.Pop()
                SetState(Nothing)
            Case Command.A
    ...
    Public Overrides Sub Render(displayBuffer As IPixelSink)
        ...
        With Context.Model.Ephemerals.SelectedPlanet.Peek
            ...
            position = font.WriteCenteredTextLines(displayBuffer, position, Context.ViewSize.Width, $"Faction: { .Parents.Faction.Name}", Hues.Black)
