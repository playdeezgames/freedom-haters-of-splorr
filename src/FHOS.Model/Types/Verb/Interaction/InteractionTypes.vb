Friend Module InteractionTypes
    ...
    Friend ReadOnly Descriptors As IReadOnlyDictionary(Of String, InteractionTypeDescriptor) =
        New List(Of InteractionTypeDescriptor) From
        {
            ...
            New EnterInteriorInteractionTypeDescriptor(Approach, "Approach", Function(x) x.Descriptor.IsPlanetVicinity OrElse x.Descriptor.Flag(FlagTypes.IsStarSystem) OrElse x.Descriptor.Flag(FlagTypes.IsStarVicinity)),
