Friend Module InteractionTypes
    ...
    Friend ReadOnly Descriptors As IReadOnlyDictionary(Of String, InteractionTypeDescriptor) =
        New List(Of InteractionTypeDescriptor) From
        {
            ...
            New TransportInteractionTypeDescriptor(LeaveOrbit, "Leave Orbit", Function(x) x.YokedActor(YokeTypes.Target).Descriptor.IsSatellite OrElse x.YokedActor(YokeTypes.Target).Descriptor.IsPlanet),
            New TransportInteractionTypeDescriptor(LeavePlanetVicinity, "Leave Planet Vicinity", Function(x) x.YokedActor(YokeTypes.Target).Descriptor.IsPlanetVicinity),
            New TransportInteractionTypeDescriptor(LeaveStarSystem, "Leave Star System", Function(x) x.YokedActor(YokeTypes.Target).Descriptor.IsStarSystem),
            New TransportInteractionTypeDescriptor(LeaveStarVicinity, "Leave Star Vicinity", Function(x) x.YokedActor(YokeTypes.Target).Descriptor.IsStarVicinity),
