Friend Module InteractionTypes
    ...
    Friend ReadOnly LeaveSatelliteOrbit As String = NameOf(LeaveSatelliteOrbit)
    ...
    Friend ReadOnly LeavePlanetOrbit As String = NameOf(LeavePlanetOrbit)
    ...
    Friend ReadOnly Descriptors As IReadOnlyDictionary(Of String, InteractionTypeDescriptor) =
        New List(Of InteractionTypeDescriptor) From
        {
            ...
            New ActorTransportInteractionTypeDescriptor(EnterWormhole, "Enter Wormhole", Function(x) x.Properties.IsWormhole),
            New ActorTransportInteractionTypeDescriptor(LeaveSatelliteOrbit, "Leave Orbit", Function(x) x.Properties.TargetActor.Properties.IsSatellite),
            New ActorTransportInteractionTypeDescriptor(LeavePlanetOrbit, "Leave Orbit", Function(x) x.Properties.TargetActor.Properties.IsPlanet),
            New ActorTransportInteractionTypeDescriptor(LeavePlanetVicinity, "Leave Planet Vicinity", Function(x) x.Properties.TargetActor.Properties.IsPlanetVicinity),
            New ActorTransportInteractionTypeDescriptor(LeaveStarSystem, "Leave Star System", Function(x) x.Properties.TargetActor.Properties.IsStarSystem),
            New ActorTransportInteractionTypeDescriptor(LeaveStarVicinity, "Leave Star Vicinity", Function(x) x.Properties.TargetActor.Properties.IsStarVicinity),
