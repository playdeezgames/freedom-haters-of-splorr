...
Friend Class SatelliteActorTypeDescriptor
    ...
    Friend Overrides Function Describe(actor As IActor) As IEnumerable(Of (Text As String, Hue As Integer))
        ...
        result.Add(($"Planet: {actor.Yokes.YokedGroup(YokeTypes.PlanetVicinity).EntityName}", Hues.Black))
        result.Add(($"Star System: {actor.Yokes.YokedGroup(YokeTypes.StarSystem).EntityName}", Hues.Black))
        Return result
    End Function
End Class
