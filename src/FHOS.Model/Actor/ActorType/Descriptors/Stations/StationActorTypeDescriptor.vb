...
Friend MustInherit Class StationActorTypeDescriptor
    ...
    Protected Overrides Sub Initialize(actor As IActor)
        ...
        actor.Properties.Groups(GroupTypes.Faction) = planet.Properties.Groups(GroupTypes.Planet).Parents.Single(Function(x) x.GroupType = GroupTypes.PlanetVicinity).Parents.Single(Function(x) x.GroupType = GroupTypes.Faction)
