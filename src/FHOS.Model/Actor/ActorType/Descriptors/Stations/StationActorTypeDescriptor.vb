...
Friend MustInherit Class StationActorTypeDescriptor
    ...
    Protected Overrides Sub Initialize(actor As IActor)
        ...
        Dim faction = planet.Properties.GetGroup(GroupTypes.Planet).Parents.Single(Function(x) x.EntityType = GroupTypes.PlanetVicinity).Parents.Single(Function(x) x.EntityType = GroupTypes.Faction)
