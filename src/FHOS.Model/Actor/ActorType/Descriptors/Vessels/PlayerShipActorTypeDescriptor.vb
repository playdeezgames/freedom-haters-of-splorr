...
Friend Class PlayerShipActorTypeDescriptor
    ...
    Protected Overrides Sub Initialize(actor As IActor)
        ...
        End If
        actor.Properties.Groups(GroupTypes.Faction) = actor.Universe.Groups.Single(Function(x) x.GroupType = GroupTypes.Faction AndAlso x.Statistics(StatisticTypes.Authority).Value = 100 AndAlso x.Statistics(StatisticTypes.Standards).Value = 100 AndAlso x.Conviction = 100)
