...
Friend Class ActorModel
    ...
    Private ReadOnly Property Glyph As Char
        Get
            Return actor.Properties.CostumeDescriptor.Glyphs(actor.State.Facing)
        End Get
    End Property
    ...
    Public ReadOnly Property PlanetCount As Integer Implements IActorModel.PlanetCount
        Get
            Return actor.Properties.LegacyGroups(GroupTypes.Faction).Statistics(StatisticTypes.PlanetCount).Value
        End Get
    End Property
    ...
    Public ReadOnly Property StarSystem As IGroupModel Implements IActorModel.StarSystem
        Get
            Return GroupModel.FromGroup(actor.Properties.LegacyGroups(GroupTypes.Faction).Parents.Single(Function(x) x.EntityType = GroupTypes.StarSystem))
        End Get
    End Property

    Public ReadOnly Property SatelliteCount As Integer Implements IActorModel.SatelliteCount
        Get
            Return actor.Properties.LegacyGroups(GroupTypes.Faction).Statistics(StatisticTypes.SatelliteCount).Value
        End Get
    End Property

    Public ReadOnly Property PlanetVicinity As IGroupModel Implements IActorModel.PlanetVicinity
        Get
            Return GroupModel.FromGroup(actor.Properties.LegacyGroups(GroupTypes.Faction).Parents.Single(Function(x) x.EntityType = GroupTypes.PlanetVicinity))
        End Get
    End Property

    Public ReadOnly Property Faction As IGroupModel Implements IActorModel.Faction
        Get
            Return GroupModel.FromGroup(actor.Properties.LegacyGroups(GroupTypes.Faction).Parents.Single(Function(x) x.EntityType = GroupTypes.Faction))
        End Get
    End Property
