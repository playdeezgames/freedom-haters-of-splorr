...
Friend Module StarTypes
    ...
    Friend ReadOnly Descriptors As IReadOnlyDictionary(Of String, StarTypeDescriptor) =
        ...
        {
            {StarTypes.Blue, New StarTypeDescriptor("Blue Star", LocationTypes.BlueStar, 1)},
            {StarTypes.BlueWhite, New StarTypeDescriptor("Blue-White Star", LocationTypes.BlueWhiteStar, 1)},
            {StarTypes.Yellow, New StarTypeDescriptor("Yellow Star", LocationTypes.YellowStar, 1)},
            {StarTypes.Orange, New StarTypeDescriptor("Orange Star", LocationTypes.OrangeStar, 1)},
            {StarTypes.Red, New StarTypeDescriptor("Red Star", LocationTypes.RedStar, 1)}
        }
