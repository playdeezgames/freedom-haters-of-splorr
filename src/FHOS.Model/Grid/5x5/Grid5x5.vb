Friend Module Grid5x5
    ...
    Friend ReadOnly Descriptors As IReadOnlyDictionary(Of String, Grid5x5Descriptor) =
        New List(Of Grid5x5Descriptor) From
        {
            ...
            New Grid5x5Descriptor(C1R2, ChrW(237)),
            New Grid5x5Descriptor(C1R3, ChrW(230)),
            New Grid5x5Descriptor(C1R4, ChrW(238)),
            New Grid5x5Descriptor(C1R5, ChrW(239)),
            New Grid5x5Descriptor(C2R1, ChrW(240)),
            New Grid5x5Descriptor(C2R2, ChrW(230)),
            New Grid5x5Descriptor(C2R3, ChrW(230)),
            New Grid5x5Descriptor(C2R4, ChrW(230)),
            New Grid5x5Descriptor(C2R5, ChrW(241)),
            ...
            New Grid5x5Descriptor(C3R5, ChrW(232)),
            New Grid5x5Descriptor(C4R1, ChrW(242)),
            New Grid5x5Descriptor(C4R2, ChrW(230)),
            New Grid5x5Descriptor(C4R3, ChrW(230)),
            New Grid5x5Descriptor(C4R4, ChrW(230)),
            New Grid5x5Descriptor(C4R5, ChrW(243)),
            New Grid5x5Descriptor(C5R1, ChrW(244)),
            New Grid5x5Descriptor(C5R2, ChrW(245)),
            New Grid5x5Descriptor(C5R3, ChrW(234)),
            New Grid5x5Descriptor(C5R4, ChrW(246)),
