...
Friend Class FactionInitializationStep
    ...
    Public Overrides Sub DoStep(addStep As Action(Of InitializationStep, Boolean))
        ...
        For Each dummy In Enumerable.Range(0, embarkSettings.FactionCount)
            ...
            universe.Factory.CreateGroup(name, 0, RNG.RollDice("10d11+-10d1"), RNG.RollDice("10d11+-10d1"), RNG.RollDice("10d11+-10d1"))
        Next
    End Sub

    Private Sub CreateSIGFED()
        Dim sigfed = universe.Factory.CreateGroup("SIGMO Federation", 1, 100, 100, 100)
    End Sub
