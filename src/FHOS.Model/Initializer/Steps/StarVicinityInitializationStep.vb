...
Friend Class StarVicinityInitializationStep
    ...
    Public Overrides Sub DoStep(addStep As Action(Of InitializationStep, Boolean))
        ...
        Dim map = descriptor.CreateMap($"{actor.Properties.EntityName} Vicinity", actor.Universe)
    ...
    Private Sub PlaceStar(externalActor As IActor)
        ...
        Dim actor = ActorTypes.Descriptors(ActorTypes.MakeStar(externalActor.Descriptor.Subtype)).CreateActor(location, externalActor.Properties.EntityName)
    End Sub
End Class
