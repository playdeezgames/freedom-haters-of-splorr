...
Friend Class StarSystemInitializationStep
    ...
    Public Overrides Sub DoStep(addStep As Action(Of InitializationStep, Boolean))
        ...
        actor.GroupsOfCategory(CategoryTypes.StarSystem).Single.Statistics(StatisticTypes.PlanetCount) = PlacePlanets(actor, addStep)
    ...
    Private Sub CreatePlanetVicinity(exteriorActor As IActor, addStep As Action(Of InitializationStep, Boolean), starType As StarTypeDescriptor, column As Integer, row As Integer)
        ...
        group.AddParent(exteriorActor.GroupsOfCategory(CategoryTypes.StarSystem).Single)
        ...
        actor.GroupCategory(exteriorActor.GroupsOfCategory(CategoryTypes.StarSystem).Single) = CategoryTypes.StarSystem
    ...
    Private Sub PlaceStar(externalActor As IActor, addStep As Action(Of InitializationStep, Boolean))
        ...
        Dim actor = ActorTypes.Descriptors(ActorTypes.MakeStarVicinity(externalActor.Descriptor.Subtype)).CreateActor(location, externalActor.GroupsOfCategory(CategoryTypes.StarSystem).Single.EntityName)
