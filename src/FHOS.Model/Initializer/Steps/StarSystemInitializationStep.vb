...
Friend Class StarSystemInitializationStep
    ...
    Public Overrides Sub DoStep(addStep As Action(Of InitializationStep, Boolean))
        ...
        actor.Properties.GetGroup(GroupTypes.StarSystem).Statistics(StatisticTypes.PlanetCount) = PlacePlanets(actor, addStep)
    ...
    Private Sub CreatePlanetVicinity(exteriorActor As IActor, addStep As Action(Of InitializationStep, Boolean), starType As StarTypeDescriptor, column As Integer, row As Integer)
        ...
        group.AddParent(exteriorActor.Properties.GetGroup(GroupTypes.StarSystem))
        ...
        actor.Properties.SetGroup(GroupTypes.StarSystem, exteriorActor.Properties.GetGroup(GroupTypes.StarSystem))
    ...
    Private Sub PlaceStar(externalActor As IActor, addStep As Action(Of InitializationStep, Boolean))
        ...
        Dim actor = ActorTypes.Descriptors(ActorTypes.MakeStarVicinity(externalActor.Descriptor.Subtype)).CreateActor(location, externalActor.Properties.GetGroup(GroupTypes.StarSystem).EntityName)
